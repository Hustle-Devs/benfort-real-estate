    ...
    <section className="bg-card py-16 sm:py-20 md:py-24 lg:py-30">
      <div className="mx-auto px-4 max-w-[1232px] myContizer">
        <div className="text-center">
          <FadeIn delay={0.2}>
            <h2 className="mb-1 sm:mb-2 lg:mb-4 font-medium text-[26px] text-primary sm:text-[32px] lg:text-[40px] leading-[44px] sm:leading-[46px] lg:leading-[48px] tracking-[-1px] sm:tracking-[-2px]">
        ...
        <div className="gap-4 lg:gap-6 grid grid-cols-1 sm:grid-cols-2 mt-14 sm:mt-18 md:mt-20 lg:mt-26 propertiesContainer">
