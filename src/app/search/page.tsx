    ...
    <section className="">
      <div className="mx-auto px-4 w-fit lg:max-w-[1464px]">
        <div className="flex gap-2 my-2">
          ...
          {/* pagination & profile */}
          <div className="hidden top-12 sm:top-14 md:top-16 lg:top-20 sticky md:flex flex-col justify-center items-center gap-1 md:gap-2 lg:gap-4 p-1 md:p-2 lg:p-3 xl:p-5 border border-border rounded-[8px] lg:rounded-[12px] w-fit max-h-[86vh]">
            <Link
              href="/"
            ...
            <Link
              href="/"
              className="group place-items-center grid bg-foreground bg-h-[48px] bg-w-[48px] hover:bg-foreground fill-background rounded-[8px] lg:rounded-[12px] w-8 md:w-10 lg:w-12 h-8 md:h-10 lg:h-12"
            >
              <svg
                className="w-5 lg:w-6"
                viewBox="0 0 24 24"
              ...
              >
                <g clipPath="url(#clip0_2_1860)">
                  <path
                    ...
                    // fill=""
                    className="active:bg-foreground fill-background"
                  />
                  <path
